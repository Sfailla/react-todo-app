...
const DashboardComponent =  (props) => (
    <div className="dash__wrapper">
        <div className="dash__header">
            ...
            <span className="dash__svg-span--user"><Icon50 icon="user" className="user" /></span>
            <p className="dash__subtitle">what would you like to do?</p>
        </div>
        <div className="dash__container">
            <div className="dash__upper-container">
                <button className="circle-button dash__button--logout" onClick={() => props.handleLogOut()}>
                    <Icon25 icon="logout" className="logout" />
                </button>
                <button className="square-button dash__button--remove-all" onClick={() => props.handleRemoveAll()}>REMOVE ALL</button>
            </div>
            <div className="dash__lower-container"> 
                ...
                {!props.completedTodos.length ? <h4 className="Form-Type completed__no-todo">No Todos Completed Yet</h4> :
